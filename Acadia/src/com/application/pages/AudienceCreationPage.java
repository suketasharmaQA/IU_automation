...
//ALL Audience Cluster creation:	
	public String ALLaudience_creation()
	{
		...
		String cluster_created = hm.get("Name").toString()+" "+ DateFunctions.get_current_timestamp();
...
//	Field input Audience Cluster creation:
	public String all_fields_audience_cluster() throws InterruptedException
	{
		...
		String cluster_forced_input = hm.get("Location").toString();
...
//						
		...
		String installedApp_forced_input = hm.get("Installed Applications").toString();
...
//						
		...
		String makers_forced_input = hm.get("Device Manufacturer / Model").toString();
		...
		String os_version_forced_input = hm.get("Os verison").toString();
		...
		String wireless_forced_input = hm.get("Wireless Operator").toString();
		...
		//SEND input to cluster name:
		String setting_cluster_name = hm.get("Name").toString()+" "+ DateFunctions.get_current_timestamp();
	...
	public boolean assert_audience_cluster_list(String cluster_name) throws InterruptedException
	{
		...
		List<WebElement> assert_cluster_list = driver.findElements(By.xpath("//*[span='Name']/parent::*/parent::*/parent::*/tbody/tr/td[1]"));
		boolean flag = false;
